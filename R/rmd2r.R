...
#' 
#' @details This function is inspired by code from Kevin Keena (http://rstudio-pubs-static.s3.amazonaws.com/12734_0a38887f19a34d92b7311a2c9cb15022.html).
...
rmd2r('~/test.Rmd', file = '~/test.R', noPlots = FALSE)
